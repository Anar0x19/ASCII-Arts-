...
class ArtConverter:
    def __init__(self, path='1 minute.mp4', font_size=12, color_lvl=8):
        pg.init()
        self.path = path
        ...
        self.record = False
        self.recorder = cv2.VideoWriter('output/123.mp4', cv2.VideoWriter_fourcc(*'mp4v'), self.rec_fps, self.RES)
